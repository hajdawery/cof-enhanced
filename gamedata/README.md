...
| `cryoffear/gameinfo.keys` | The `gameinfo.txt` keys this milestone needs: `render_picbutton_text`, `startmap`, `noskills`. | `filesystem/gameinfo.c:352-444`, `engine/client/dll_int/cl_gameui.c:376-406` |
...
See [docs/cof-ui-m1-plumbing.md](../docs/cof-ui-m1-plumbing.md) for what each
one was verified to do and for the evidence.
