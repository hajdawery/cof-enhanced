...
Fear's own UI samples (`docs/cof-ui-m3-theme.md` § *Menu sounds*) because none
...
`docs/cof-ui-menu-map-redirect.md`), and the engine menu was playing them at
`1.0`.
...
and `r_detailtextures` to `0`. See `docs/cof-ui-m3-theme.md` § *Menu sounds
