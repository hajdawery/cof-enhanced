...
> **Historical checkpoint (2026-09-20).** The "open regression" in the last
> section (menu stays visible while footsteps play after Load Game) was resolved
> by the menu-transition work and then replaced outright by the unified engine
> menu (milestones 1-3); loading real Steam saves from the menu has been
> user-verified since 2026-09-20. See [milestones](milestones.md).
