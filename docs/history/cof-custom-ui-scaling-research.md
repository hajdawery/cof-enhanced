...
> **Historical research (2026-09-21).** The in-game UI scaling it prepares for is
> implemented: [UI scaling](../design/ui-scaling.md) (`cof_ui_scale`) and
> [VGUI Inter fonts](../design/vgui-inter-fonts.md). Its "Future menu styling
> backlog" became the [UI theme](../design/ui-theme.md). Kept for the ownership
> map and coordinate-space evidence.
...
The existing [custom UI regression checklist](../dev/custom-ui-regression-checklist.md)
...
Keep the full interaction plan in the [custom UI regression checklist](../dev/custom-ui-regression-checklist.md),
the measured reference anchors in the [display audit](../dev/display-reference-audit.md),
