...
> **Stack position (2026-09-22 docs pass):** the verified stacks apply this
> after the skyline trace (step 30 of [the patch stack](../dev/patch-stack.md)),
> not before the entity/transparent/skyline diagnostics as written below; that
> is the order known to apply.
