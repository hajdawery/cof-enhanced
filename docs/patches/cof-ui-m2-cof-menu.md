...
> **Superseded in part.** The main-menu item list and the Language page below are
> the milestone-2 state. Since 2026-09-22 the main menu is New Game, Load Game,
> Custom Campaign, Extras (Join co-op, Host co-op, Unlockables, Links, Credits),
> Options, Quit ([UI theme](../design/ui-theme.md), "Options audit, main-list
> restructure"), the language choice is one Language option on the Game page
> ([language packs](../design/language-packs.md) section 7), and Join/Host are the
> co-op pages ([co-op bridge](../design/coop-bridge.md)).
...
Milestone 1 (`docs/patches/cof-ui-m1-plumbing.md`) put the engine menu on screen over
...
*Unlockables round* section of [the milestone 3 theme](../design/ui-theme.md).
